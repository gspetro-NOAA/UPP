...
!     
  ...
  character(len=13),parameter,dimension(1:n_sensors):: sensorlist= &
      (/'amsre_aqua          ', &
        'tmi_trmm            ', &
        'ssmis_f17           ', &
        'ssmis_f18           ', &
        ...
        'abi_g18             ', &
        'ahi_himawari8       '/)
  character(len=20),parameter,dimension(1:n_sensors):: obslist=  &
      (/'amsre        ', &
        'tmi          ', &
        'ssmis        ', &
        'ssmis        ', &
           ...
           nonnadir: if((isis=='ssmis_f17' .and. post_ssmis17) .OR. &
              ...
              do j=jsta,jend
                 loopi2:do i=ista,iend
                    ...
                    if(isis=='abi_g16')then  ! positions should be controlled by runtime setting or fix file
                       sublat=0.0
                       sublon=-75.2
